...
import {
  ...
  ClearChatButton, LogoutButton, PremiumCopyButton, PremiumCopyNumber, PremiumCopyLabel,
...
// TEMP_COPY_BUTTON_COMPONENT_START — remove to clean up
function CopyIdButton() {
  const [isCopied, setIsCopied] = React.useState(false);
  const handleCopy = () => {
    navigator.clipboard.writeText('97652945978254').then(() => {
      setIsCopied(true);
      setTimeout(() => setIsCopied(false), 2500);
    });
  };
  return (
    <PremiumCopyButton $copied={isCopied} onClick={handleCopy}>
      <PremiumCopyNumber>97652945978254</PremiumCopyNumber>
      <PremiumCopyLabel $copied={isCopied}>
        {isCopied ? (
          <>
...
// TEMP_COPY_BUTTON_COMPONENT_END
      ...
      <AppContainer>
        ...
        <LayoutContainer>
          ...
          <UserSidebar $isVisible={isUserListVisible}>
            ...
            {roomId === 'me' && (
              /* TEMP_COPY_BUTTON_START — remove this block to clean up */
              <CopyIdButton />
              /* TEMP_COPY_BUTTON_END */
            )}
